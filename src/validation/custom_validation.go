...
func RegisterCustomValidation(v *validator.Validate) {
	...
	v.RegisterValidation("course_level", func(fl validator.FieldLevel) bool {
	...
	v.RegisterValidation("course_status", func(fl validator.FieldLevel) bool {
	...
	v.RegisterValidation("language_code", func(fl validator.FieldLevel) bool {
	...
	v.RegisterValidation("positive_float", func(fl validator.FieldLevel) bool {
